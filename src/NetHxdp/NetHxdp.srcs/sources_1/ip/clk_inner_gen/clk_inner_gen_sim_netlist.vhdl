...
-- Date        : Fri Dec  6 11:57:25 2024
-- Host        : MAHPELLA running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               E:/Projects/Wissance/FpgaNetHXDP/src/NetHxdp/NetHxdp.srcs/sources_1/ip/clk_inner_gen/clk_inner_gen_sim_netlist.vhdl
-- Design      : clk_inner_gen
...
entity clk_inner_gen_clk_inner_gen_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_inner_gen_clk_inner_gen_clk_wiz : entity is "clk_inner_gen_clk_wiz";
end clk_inner_gen_clk_inner_gen_clk_wiz;

architecture STRUCTURE of clk_inner_gen_clk_inner_gen_clk_wiz is
  signal clk_in1_clk_inner_gen : STD_LOGIC;
  signal clk_out1_clk_inner_gen : STD_LOGIC;
  signal clk_out1_clk_inner_gen_en_clk : STD_LOGIC;
  signal clk_out2_clk_inner_gen : STD_LOGIC;
  signal clk_out2_clk_inner_gen_en_clk : STD_LOGIC;
  signal clk_out3_clk_inner_gen : STD_LOGIC;
  signal clk_out3_clk_inner_gen_en_clk : STD_LOGIC;
  signal clkfbout_buf_clk_inner_gen : STD_LOGIC;
  signal clkfbout_clk_inner_gen : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_clk_inner_gen,
      O => clkfbout_buf_clk_inner_gen
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_clk_inner_gen,
      O => clk_out1_clk_inner_gen_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out2_clk_inner_gen,
      O => clk_out2_clk_inner_gen_en_clk
    );
...
clkout3_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out3_clk_inner_gen,
      O => clk_out3_clk_inner_gen_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_clk_inner_gen,
      CLKFBOUT => clkfbout_clk_inner_gen,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_clk_inner_gen,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_clk_inner_gen,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_clk_inner_gen,
      CLKOUT1B => NLW_mmcm_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clk_out3_clk_inner_gen,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_clk_inner_gen_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg1(0)
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_clk_inner_gen_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg2(0)
...
\seq_reg3_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out3_clk_inner_gen_en_clk,
      CE => '1',
      CLR => reset,
      D => \^locked\,
      Q => seq_reg3(0)
...
entity clk_inner_gen is
  ...
  attribute NotValidForBitStream of clk_inner_gen : entity is true;
end clk_inner_gen;

architecture STRUCTURE of clk_inner_gen is
begin
inst: entity work.clk_inner_gen_clk_inner_gen_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
